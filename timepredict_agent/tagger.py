...
TOPIC_PATTERNS = {
    ...
    "Large language model": r"large language model|\bllm\b|language model",
    "Multimodal LLM": r"multimodal large language model|multimodal llm|vision-language|vision language|\bvlm\b",
    "Reinforcement learning": r"reinforcement learning|policy optimization|policy gradient",
    "GRPO": r"group relative policy optimization|\bgrpo\b",
    "Chain-of-thought": r"chain-of-thought|\bcot\b|reasoning chain",
    "Affordance reasoning": r"affordance|affordance grounding|affordance reasoning",
    "Embodied AI": r"embodied|robot|robotic|manipulation|open-world",
